import { pedidosGuardados } from '../../pedidos/logica/pedidos.guardados.datos.js';
import { findOptionData } from '../../venta/logica/modal.logica.js';
import { catalogoProductos } from '../../venta/logica/catalogo.datos.js';
...
import { FASES_PEDIDO } from '../../pedidos/logica/pedidos.fases.datos.js'; // <-- AÑADIR IMPORTACIÓN
...
export async function openItemsTablajeroModal(pedidoId, itemIndex, callback) {
    ...
    const response = await fetch('src/modulos/items.tablajero/views/items.tablajero.modal.html');
